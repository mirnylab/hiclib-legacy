...
Most of the filenames are defined within the text, but you can redefine them in the beginning. 
...
def plotCorrelationAtDifferentBinning():
    ...
    if create == True:  
        if cache == True:
            ...
            FR = fragmentHiC.HiCdataset("bla","../../data/hg18",override = False,inMemory = True )
            FR.load("../../ErezPaperData/hg18/GM-HindIII-hg18_refined.frag")
        
            FR3 = fragmentHiC.HiCdataset("bla","../../data/hg18",override = False,inMemory = True )
        ...
        for size in sizes: 
            FR.saveHeatmap("../../tcc/working/HindIII_%d.hm" % size, size * 1000000)
            FR2.saveHeatmap("../../tcc/working/NcoI_%d.hm" % size, size * 1000000)
            FR3.saveHeatmap("../../tcc/working/control_%d.hm" % size, size * 1000000)
...
def heatmapFromHotFragments(dataset = "../../mouse/data/combined/mouse1_merged.frag", 
    ...
    FH.maskFilter(arrayInArray(FH.fragids1,frag96) + arrayInArray(FH.fragids2,frag96))
    hm98100 = FH.buildAllHeatmap(5000000)
    FH.maskFilter(arrayInArray(FH.fragids1,frag98) + arrayInArray(FH.fragids2,frag98))
...
def plotCisToTransHotFragments(dataset = "../../mouse/data/combined/mouse1_merged.frag", 
                            workingFile = "../../tcc/working/workingMouse.frag", 
                            cacheFile = "../../tcc/working/workingMouseFiltered.frag",
    ...
    plt.plot(0.5 * (values[1][:-1] + values[1][1:]),values[0]/counts[0],'.',label = label)    
    
     
    for linep in p1,p2,p3: plt.vlines(linep,0,1)
...
def doAllPlotsForHotFragments():
    ...
    plotCisToTransHotFragments(dataset = "../../tcc/hg18/tcc-HindIII-hg18_merged.frag",
                                workingFile = "../../tcc/working/workingTcc.frag", 
                                cacheFile = "../../tcc/working/workingTccFiltered.frag",
                                genomeFolder = "../../data/hg18",
                                label = "Kalhor, 2011")
    
    heatmapFromHotFragments(dataset = "../../tcc/hg18/tcc-HindIII-hg18_merged.frag",
                                workingFile = "../../tcc/working/workingTcc.frag", 
                                cacheFile = "../../tcc/working/workingTccFiltered.frag",
                                genomeFolder = "../../data/hg18",
                                label = "(Kalhor, 2011)")
    ...
    plotCisToTransHotFragments(dataset = "../../ErezPaperData/hg18/GM-HindIII-hg18_merged.frag",
    ...
    heatmapFromHotFragments(dataset = "../../ErezPaperData/hg18/GM-HindIII-hg18_merged.frag",
                                workingFile = "../../tcc/working/workingErez.frag", 
                                cacheFile = "../../tcc/working/workingErezFiltered.frag",
                                genomeFolder = "../../data/hg18",
                                label = "(Lieberman, 2009)")
...
def compareMouseWithGenomicFeatures():
    ...
    datasets = {"H3k73me3":("wgEncodeCaltechHistC2c12Ab2621FCntrl50bPcr1xSigRep1.bigWig","wgEncodeCaltechHistC2c12InputFCntrl50bPcr1xSigRep1.bigWig"),
                "H3k79me2":("wgEncodeCaltechHistC2c12Ab3594FCntrl50bPcr1xSigRep1.bigWig","wgEncodeCaltechHistC2c12InputFCntrl50bPcr1xSigRep1.bigWig"),
                "H3ac":("wgEncodeCaltechHistC2c12H3ac06599FCntrl32bPcr2xSigRep1.bigWig","wgEncodeCaltechHistC2c12InputFCntrl32bPcr2xSigRep1.bigWig"),
                "H3k04me3":("wgEncodeCaltechHistC2c12H3k04me3FCntrl50bPcr1xSigRep1.bigWig","wgEncodeCaltechHistC2c12InputFCntrl50bPcr1xSigRep1.bigWig"),
                "H3k27me3":("wgEncodeCaltechHistC2c12H3k27me3FCntrl32bPcr2xSigRep1.bigWig","wgEncodeCaltechHistC2c12InputFCntrl32bPcr2xSigRep1.bigWig"),
                "H3k36me3":("wgEncodeCaltechHistC2c12H3k36me3FCntrl50bPcr1xSigRep1.bigWig","wgEncodeCaltechHistC2c12InputFCntrl50bPcr1xSigRep1.bigWig"),
                "UW_DNAse":("wgEncodeUwDnaseBcellcd43nC57bl6MAdult8wksSigRep1.bigWig",None)                 
                }

    
    for key in datasets.keys(): 
        mark  = os.path.join("../../histoneMarks/mm9",datasets[key][0])
        if datasets[key][1] != None:
